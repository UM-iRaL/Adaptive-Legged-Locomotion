function dynamicsModelL1(parameter)
...
%add variables for l1
param_sigma = SX.sym('param_sigma', [parameter.size_target_mask, 1]);
...
EOM(7:(7+parameter.size_target_mask-1)) = EOM(7:(7+parameter.size_target_mask-1)) - dt * param_sigma;
...
p = [dt; mu; feet_location; param_sigma];
