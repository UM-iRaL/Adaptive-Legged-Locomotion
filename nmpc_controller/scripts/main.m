...
parameter.physics.mass_body_body=parameter.physics.sim2real_scale_factor*7.388; % Only body weight of spirit
...
parameter.physics.hip_offset=[0.2263; 0.07; 0]; % Absolute hip offset from body COM of spirit *was 0.098*
