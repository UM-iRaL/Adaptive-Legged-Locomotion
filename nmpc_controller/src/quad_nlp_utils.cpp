...
void quadNLP::loadCasadiFuncs() {
  // std::cout << "num_sys_id: " <<  num_sys_id_ << std::endl;
  ...
  // MATLAB file for *nominal* model, meaning that no rf 
  ...
  // MATLAB file for *rf* model, different files are used
  // Load basic leg controller functions for go2
  eval_vec_[GO2_RF][FUNC] = eval_g_go2_rf;
  eval_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf;
  eval_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf;
  eval_work_vec_[GO2_RF][FUNC] = eval_g_go2_rf_work;
  eval_work_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_work;
  eval_work_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_work;
  eval_incref_vec_[GO2_RF][FUNC] = eval_g_go2_rf_incref;
  eval_incref_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_incref;
  eval_incref_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_incref;
  eval_decref_vec_[GO2_RF][FUNC] = eval_g_go2_rf_decref;
  eval_decref_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_decref;
  eval_decref_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_decref;
  eval_checkout_vec_[GO2_RF][FUNC] = eval_g_go2_rf_checkout;
  eval_checkout_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_checkout;
  eval_checkout_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_checkout;
  eval_release_vec_[GO2_RF][FUNC] = eval_g_go2_rf_release;
  eval_release_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_release;
  eval_release_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_release;
  eval_sparsity_vec_[GO2_RF][FUNC] = eval_g_go2_rf_sparsity_out;
  eval_sparsity_vec_[GO2_RF][JAC] = eval_jac_g_go2_rf_sparsity_out;
  eval_sparsity_vec_[GO2_RF][HESS] = eval_hess_g_go2_rf_sparsity_out;

  // MATLAB file for *l1* model, different files are used
  // Load basic leg controller functions for go2
  eval_vec_[GO2_L1][FUNC] = eval_g_go2_l1;
  eval_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1;
  eval_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1;
  eval_work_vec_[GO2_L1][FUNC] = eval_g_go2_l1_work;
  eval_work_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_work;
  eval_work_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_work;
  eval_incref_vec_[GO2_L1][FUNC] = eval_g_go2_l1_incref;
  eval_incref_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_incref;
  eval_incref_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_incref;
  eval_decref_vec_[GO2_L1][FUNC] = eval_g_go2_l1_decref;
  eval_decref_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_decref;
  eval_decref_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_decref;
  eval_checkout_vec_[GO2_L1][FUNC] = eval_g_go2_l1_checkout;
  eval_checkout_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_checkout;
  eval_checkout_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_checkout;
  eval_release_vec_[GO2_L1][FUNC] = eval_g_go2_l1_release;
  eval_release_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_release;
  eval_release_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_release;
  eval_sparsity_vec_[GO2_L1][FUNC] = eval_g_go2_l1_sparsity_out;
  eval_sparsity_vec_[GO2_L1][JAC] = eval_jac_g_go2_l1_sparsity_out;
  eval_sparsity_vec_[GO2_L1][HESS] = eval_hess_g_go2_l1_sparsity_out;
