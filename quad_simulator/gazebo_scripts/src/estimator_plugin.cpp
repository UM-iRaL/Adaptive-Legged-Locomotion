...
void QuadEstimatorGroundTruth::OnUpdate() {
  ...
  // std::cout <<  "----------------Position error in FK----------------" << std::endl;
  // std::cout <<  state.feet.feet[0].position.x - toe0_pos.X() << ", " <<
  //               state.feet.feet[0].position.y - toe0_pos.Y() << ", " <<
  //               state.feet.feet[0].position.z - toe0_pos.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[1].position.x - toe1_pos.X() << ", " <<
  //               state.feet.feet[1].position.y - toe1_pos.Y() << ", " <<
  //               state.feet.feet[1].position.z - toe1_pos.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[2].position.x - toe2_pos.X() << ", " <<
  //               state.feet.feet[2].position.y - toe2_pos.Y() << ", " <<
  //               state.feet.feet[2].position.z - toe2_pos.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[3].position.x - toe3_pos.X() << ", " <<
  //               state.feet.feet[3].position.y - toe3_pos.Y() << ", " <<
  //               state.feet.feet[3].position.z - toe3_pos.Z() << ", " << std::endl;

  // std::cout <<  "----------------Velocity error in FK----------------" << std::endl;
  // std::cout <<  state.feet.feet[0].velocity.x - toe0_vel.X() << ", " <<
  //               state.feet.feet[0].velocity.y - toe0_vel.Y() << ", " <<
  //               state.feet.feet[0].velocity.z - toe0_vel.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[1].velocity.x - toe1_vel.X() << ", " <<
  //               state.feet.feet[1].velocity.y - toe1_vel.Y() << ", " <<
  //               state.feet.feet[1].velocity.z - toe1_vel.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[2].velocity.x - toe2_vel.X() << ", " <<
  //               state.feet.feet[2].velocity.y - toe2_vel.Y() << ", " <<
  //               state.feet.feet[2].velocity.z - toe2_vel.Z() << ", " << std::endl;
  // std::cout <<  state.feet.feet[3].velocity.x - toe3_vel.X() << ", " <<
  //               state.feet.feet[3].velocity.y - toe3_vel.Y() << ", " <<
  //               state.feet.feet[3].velocity.z - toe3_vel.Z() << ", " << std::endl;
